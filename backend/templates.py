...
CRITIQUE_TEMPLATE = (
    ...
    "また、1回目の回答、TAのフィードバックがある場合は参考に、論点を修正してください。\n"
    "【フォーマット】\n"
    "{format_instructions}\n"
    "\n"
    "【報告文】:\n"
...
FIX_CRITIQUE_TEMPLATE = """
    あなたは国際政治演習に参加しているTeaching Assistantで, 生徒の批判的視点からの論点を修正する専門家です。
	以下の論点について、生徒が抽出した論点に対してフィードバックを行ってください。
	【論点】
	{critic_content}
	注意:
	- 論点それぞれについて、フィードバックを箇条書きしてください。
"""
